...
import styles from "./../../css/style-perfil-usuario.module.css"
...
export function Configuracion() {
    ...
    return (
        <main>
            <h1 className={styles["titulo-configuracion"]}>CONFIGURACIÓN DE LA CUENTA</h1>
            <div className={styles["contenedor-perfil"]}>
                <section className={styles["card-perfil"]}>
