    ...
    return (
        <>
            <li className="elem-loc">
                    <img src={`${process.env.PUBLIC_URL}/img/Alojamientos/hotelCarlos.webp`} alt={alojamiento.name}/>
                    ...
                    <div id="info-loc">
                        ...
                        <div id="estrellas">
                            <img id="icono-estrella" src={`${process.env.PUBLIC_URL}/img/Iconos/estrella.svg`} alt="estrella"/>
                            <img id="icono-estrella" src={`${process.env.PUBLIC_URL}/img/Iconos/estrella.svg`} alt="estrella"/>
                            <img id="icono-estrella" src={`${process.env.PUBLIC_URL}/img/Iconos/estrella.svg`} alt="estrella"/>
                            <img id="icono-estrella" src={`${process.env.PUBLIC_URL}/img/Iconos/estrella.svg`} alt="estrella"/>
                        </div>
